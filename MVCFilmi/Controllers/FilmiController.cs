...
namespace MVCFilmi.Controllers
{
    public class FilmiController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Naslov,Izdanm,Tip,Cena")] Filmi filmi)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Naslov,Izdanm,Tip,Cena")] Filmi filmi)
        {
            if (ModelState.IsValid)
            {
